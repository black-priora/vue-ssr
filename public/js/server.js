...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_App_vue__ = __webpack_require__(4);
  ...
  return _c(
    ...
    [
      _vm._l(_vm.list, function(l) {
        return _c("div", { key: l.id }, [
          _c("div", { on: { click: _vm.click } }, [_vm._v(_vm._s(l.name))]),
          _vm._v(" "),
          _c("div", [_vm._v(_vm._s(l.notice))])
        ])
      }),
      _vm._v(" "),
      _c("div", { on: { click: _vm.click } }, [_vm._v("@@")]),
      _vm._v(" "),
      _c("router-view"),
      _vm._v(" "),
